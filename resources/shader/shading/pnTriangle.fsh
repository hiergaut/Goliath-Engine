...
vec3 CalcSpotLight(SpotLight light, vec3 normal, vec3 fragPos, vec3 viewDir, vec3 lightDir, vec2 texCoords);
...
void main()
{
        ...
        if (userColor) {
                ...
                //                        texCoords = ParallaxMapping2(TexCoords, viewDir);
                ...
                for(int i = 0; i < nbPointLight; i++) {
                        ...
                        result += CalcPointLight(pointLights[i], normal, FragPos, viewDir, lightDir, texCoords);
                }
                //    // phase 3: spot light
                for(int i =0; i <nbSpotLight; ++i) {
                        ...
                        //                        }
                        result += CalcSpotLight(spotLights[i], normal, FragPos, viewDir, lightDir, texCoords);
                }
